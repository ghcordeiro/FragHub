...
FRAGHUB_STATE_DIR="${FRAGHUB_STATE_DIR:-${HOME}/.fraghub/installer/state}"
...
run_summary() {
  ...
  echo ""
  echo "=========================================="
  echo "  FragHub — resumo da instalacao (v0.3)"
  echo "=========================================="
  echo ""
  ...
  echo "  - 3001 API backend (health: /health)"
  ...
  echo "  - Estado:   ${FRAGHUB_STATE_DIR}/steps.env"
  echo "  - Log:      ${LOG_FILE}"
  echo ""
