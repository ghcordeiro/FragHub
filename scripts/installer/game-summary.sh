...
run_game_summary() {
  ...
  echo ""
  echo "=========================================="
  echo "  FragHub — resumo da stack de jogo (v0.2)"
  echo "=========================================="
  echo ""
  ...
  check_marker "CS2-SimpleAdmin" "${FRAGHUB_GAME_ROOT}/cs2/plugins/extended/CS2-SimpleAdmin/CS2-SimpleAdmin.dll"
  check_marker "WeaponPaints" "${FRAGHUB_GAME_ROOT}/cs2/plugins/extended/WeaponPaints/WeaponPaints.dll"
  echo ""
  echo "## Plugins CS:GO"
  ...
  check_marker "SourceBans++" "${FRAGHUB_GAME_ROOT}/csgo/plugins/extended/SourceBans++/sourcebans.smx"
  check_marker "Weapons & Knives" "${FRAGHUB_GAME_ROOT}/csgo/plugins/extended/WeaponsKnives/weaponsknives.smx"
  check_marker "RankMe" "${FRAGHUB_GAME_ROOT}/csgo/plugins/extended/RankMe/rankme.smx"
  echo ""
  echo "## Servicos"
